...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1B3A6B);
  late Color secondary = const Color(0xFF7BA9D0);
  late Color tertiary = const Color(0xFFC9A961);
  ...
  late Color primaryBackground = const Color(0xFFFAFAF8);
  ...
  late Color warning = const Color(0xFFBA7517);
  late Color error = const Color(0xFFA32D2D);
  late Color info = const Color(0xFF185FA5);
}
